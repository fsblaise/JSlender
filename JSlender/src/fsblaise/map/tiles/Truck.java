 ...
 * A teherautó adataiért, tulajdonságaiért.
 * A teherautó solid, azaz nem járható be a játékos által.
 *
...
public class Truck extends Tile{
     ...
     */
    public Truck(int x, int y, int width, int height, TileType type, boolean container, boolean containingpaper) {
